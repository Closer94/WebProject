...
<html>
	...
	%>
        ...
        <table style="margin-left:80px; border-collapse: collapse;">
            ...
            <tr><td>&nbsp;</td></tr>
            <%
            String temp = "<tr><td style='text-align:center; background-color:#f9f9f9; padding:10px; border-bottom:1px solid #d3d3d3;'>닉네임</td><td style='border-bottom:1px solid #d3d3d3;'><input type='text' name='nickname' id='nickname' value='"+name+"' style='width:100px; height:20px; margin-left:20px;padding-left:10px;'></td></tr>";
            out.println(temp);
            %>
            
            <tr><td style="text-align:center; background-color:#f9f9f9; padding:10px; border-bottom:1px solid #d3d3d3;">아이디</td><td style="padding-left:20px; border-bottom:1px solid #d3d3d3;"><%= user_id %></td></tr>
			...
			%>
        			<tr>
                    <td rowspan="2" style="text-align:center; background-color:#f9f9f9; padding:10px; border-bottom:1px solid #d3d3d3;">이메일 수신여부</td>
           ...
           %>
			...
			%>  
                    ...
                    <option value="4">충청</option>
                    <option value="5">전라</option>
                    <option selected value="6">경상</option>    
			<%
				}
			%>
                    </select>
