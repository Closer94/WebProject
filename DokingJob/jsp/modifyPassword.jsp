...
<html>
    ...
    <body style="background:#edf1f8;" class = positionBody>
        ...
        <form method='post' action='myinfo_change.jsp'>
                ...
                <table style="margin-left: 30px; margin-top: 40px;">
                    <tr>
                        ...
                        <td colspan="3" style="padding:0.6em; border: 1px solid #dadada;background-color: white;">
                            <input type="password" name='old_password' id='old_password' placeholder="현재 비밀번호를 입력해주세요." size ="40" style="border-style:none; height:25px; font-size:15px;">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="padding:0.6em; border: 1px solid #dadada;background-color: white;">
                            <input type="password" name='new_password' id='new_password' placeholder="새 비밀번호를 입력해주세요." size ="40" style="border-style:none; height:25px; font-size:15px;">
                        </td>
                    </tr>
                </table>
                <table>
